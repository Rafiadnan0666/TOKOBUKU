...
if ($search) {
    $buk = mysqli_query($conn, "SELECT buku.*, penerbit.nama FROM penerbit INNER JOIN buku ON buku.penerbit = penerbit.id WHERE nama_buku LIKE '%$search%'");
} else {
    $buk = mysqli_query($conn, "SELECT buku.*, penerbit.nama FROM penerbit INNER JOIN buku ON buku.penerbit = penerbit.id");
}
?>
                        ...
                        <div class="header-left">
                            <div class="search_bar dropdown">
                                ...
                                <div class="dropdown-menu p-0 m-0">
                                    <form>
                                        <input class="form-control" type="search" placeholder="Search" aria-label="Search" name="search" value="<?= htmlspecialchars($search) ?>">
                                    </form>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <a href="tambah.php"><button class="btn btn-primary"><i class="fa fa-save"></i></button></a>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $p["nama"] ?></td>
                                            <td>
                                                <a href="update.php?id=<?= $p["id"] ?>"><button class="btn btn-warning"><i class="fa fa-pencil"></i></button></a>
                                                <a href="hapus.php?id=<?= $p["id"] ?>"><button class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
                                            </td>
                                        </tr>
                                    <?php  }  ?>
                                </tbody>
