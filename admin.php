                    ...
                    <div class="row page-titles mx-0 bg-primary text-white">
                        <div class="col-sm-6 ">
                            <div class="welcome-text text-white">
                                <h4 class="text-white">Penerbit </h4>                              
                            </div>
                        </div>
                        <div class="col-sm-6  justify-content-sm-end mt-2 mt-sm-0 d-flex">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active"><a href="javascript:void(0)">Admin</a></li>
                                <li class="breadcrumb-item active"><a href="penerbit/index.php">Penerbit</a></li>
                            </ol>
                        </div>
                    </div>
                </a>
                <a href="buku/index.php">
                    <div class="row page-titles mx-0 bg-warning text-white">
                        <div class="col-sm-6 ">
                            <div class="welcome-text text-white">
                                <h4 class="text-white">Buku</h4>                              
                            </div>
                        </div>
                        <div class="col-sm-6  justify-content-sm-end mt-2 mt-sm-0 d-flex">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active"><a href="javascript:void(0)">Admin</a></li>
                                <li class="breadcrumb-item active"><a href="buku/index.php">Buku</a></li>
                            </ol>
                        </div>
                    </div>
                </a>
