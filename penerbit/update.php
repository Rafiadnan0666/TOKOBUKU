...
require "../config.php";
$id = $_GET["id"];
$p = mysqli_query($conn, "SELECT * FROM penerbit WHERE id = $id");
...
if (isset($_POST["sub"])) {
    ...
    mysqli_query($conn, "UPDATE penerbit SET kode = '$kode' ,kota = '$kota',nama = '$nama', alamat = '$alamat', kota = '$kota' , telepon = '$telepon' WHERE id = $id");
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Penerbit</a></li>
                        </ol>
                    </div>
                </div>
                <a href="index.php">
                ...
                <form method="post">
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <input type="text" value="<?= $e["nama"] ?>" name="nama" class="form-control mb-2  col-md-6" id="nama" placeholder="Enter nama">

                        </div>
                        <div class="row">
                            <label for="kota" class="col-md-2">kota</label>
                            <input type="text" value="<?= $e["kota"] ?>" name="kota" class="form-control mb-2  col-md-6" id="kota" placeholder="Enter kota">

                        </div>
                        <div class="row">
                            <label for="alamat" class="col-md-2">alamat</label>
                            <input type="text" value="<?= $e["alamat"] ?>" name="alamat" class="form-control mb-2  col-md-6" id="alamat" placeholder="Enter alamat">

                        </div>
                        <div class="row">
                            <label for="telepon" class="col-md-2">telepon</label>
                            <input type="number" value="<?= $e["telepon"] ?>" name="telepon" class="form-control mb-2 col-md-6" id="telepon" placeholder="Enter telepon">
