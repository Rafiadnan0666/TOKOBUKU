...
if (isset($_POST["sub"])) {
    ...
    mysqli_query($conn, "INSERT INTO penerbit (kode, nama, alamat, kota, telepon) VALUES ('$kode', '$nama','$alamat','$kota','$telepon')");
                ...
                <form method="post">
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <input type="text" name="nama" class="form-control mb-2  col-md-6" id="nama" placeholder="Enter nama">

                        </div>
                        <div class="row">
                            <label for="kota" class="col-md-2">kota</label>
                            <input type="text" name="kota" class="form-control mb-2  col-md-6" id="kota" placeholder="Enter kota">

                        </div>
                        <div class="row">
                            <label for="alamat" class="col-md-2">alamat</label>
                            <input type="text" name="alamat" class="form-control mb-2  col-md-6" id="alamat" placeholder="Enter alamat">

                        </div>
                        <div class="row">
                            <label for="telepon" class="col-md-2">telepon</label>
                            <input type="number" name="telepon" class="form-control mb-2 col-md-6" id="telepon" placeholder="Enter telepon">
