...
if (isset($_POST["sub"])) {
    ...
    mysqli_query($conn, "INSERT INTO buku (kode, kategori,nama_buku, harga, stok, penerbit) VALUES ('$kode','$kategori', '$nama_buku','$harga','$stok','$penerbit')");
                ...
                <form method="post">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <input type="text" name="kode" class="form-control mb-2   col-md-6" id="kode">

                        </div>
                        <div class="row">
                            <label for="kategori" class="col-md-2">kategori</label>
                            <input type="text" name="kategori" class="form-control mb-2  col-md-6" id="kategori" placeholder="Enter kategori">

                        </div>
                        <div class="row">
                            <label for="nama_buku" class="col-md-2">nama_buku</label>
                            <input type="text" name="nama_buku" class="form-control mb-2  col-md-6" id="nama_buku" placeholder="Enter nama_buku">

                        </div>
                        <div class="row">
                            <label for="stok" class="col-md-2">stok</label>
                            <input type="text" name="stok" class="form-control mb-2  col-md-6" id="stok" placeholder="Enter stok">

                        </div>
                        <div class="row">
                            <label for="harga" class="col-md-2">harga</label>
                            <input type="text" name="harga" class="form-control mb-2  col-md-6" id="harga" placeholder="Enter harga">

                        </div>
                        <div class="row">
                            <label for="penerbit" class="col-md-2">penerbit</label>
                            <select name="penerbit" id="" class="custom-select">
                                <option>-- Pilih --</option>
                                <?php foreach ($pen as $n) {
                                ?>
