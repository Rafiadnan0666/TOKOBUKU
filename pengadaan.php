...
if ($search) {
    ...
    $buk = mysqli_query($conn, "SELECT buku.*, penerbit.nama FROM penerbit INNER JOIN buku ON buku.penerbit = penerbit.id ORDER BY stok ASC LIMIT 1");
}
?>
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 ">
                        <div class="welcome-text">
                            ...
                            <p class="mb-0">Stok Tinggal Sedikit</p>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Pengadaan</a></li>
                        </ol>
                    </div>
                </div>
